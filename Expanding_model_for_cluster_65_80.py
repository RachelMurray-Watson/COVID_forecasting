...
HSA_weekly_data_all = pd.read_csv(
    "/gpfs/gibbs/project/yaesoubi/rem76/hsa_time_data_all_dates_weekly.csv"
)
...
new_directory = "/Expanding_models_15_per_100k/"
...
######### ACTUAL RUNS ############
weeks_to_predict = range(
    65, 80
)  # first classifier has minimum train_weeks_for_initial_model weeks of data?
...
pickle.dump(norm_MCC_by_week_full_period, open("norm_MCC_by_week_full_period", "wb"))

pickle.dump(accuracy_by_week_full_period, open("accuracy_by_week_full", "wb"))
pickle.dump(npv_by_week_full_period, open("npv_by_week_full", "wb"))
pickle.dump(ppv_by_week_full_period, open("ppv_by_week_full", "wb"))
pickle.dump(sensitivity_by_week_full_period, open("sensitivity_by_week_full", "wb"))
pickle.dump(specificity_by_week_full_period, open("specificity_by_week_full", "wb"))
pickle.dump(ROC_by_week_full_period, open("ROC_by_week_full", "wb"))
