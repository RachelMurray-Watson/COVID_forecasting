...
data_by_HSA = pd.read_csv('/gpfs/gibbs/project/yaesoubi/rem76/hsa_time_data_all_dates.csv')
...
new_directory = '/Six_month_models_10_per_100k/'
...
for prediction_week in weeks_to_predict:
    ...
    model_name_to_save = "Full_model_10_per_100_" + time_period + "_" + str(prediction_week) + ".sav"
...
for prediction_week in weeks_to_predict:
    print(prediction_week)
    model_name_to_load = "Full_model_10_per_100_" + time_period + "_" + str(prediction_week) + ".sav"
...
pickle.dump(accuracy_by_HSA_full, open('accuracy_by_HSA_full', 'wb'))
pickle.dump(npv_by_week_full, open('npv_by_week_full', 'wb'))
pickle.dump(ppv_by_week_full, open('ppv_by_week_full', 'wb'))
pickle.dump(sensitivity_by_week_full, open('sensitivity_by_week_full', 'wb'))
pickle.dump(specificity_by_week_full, open('specificity_by_week_full', 'wb'))
pickle.dump(ROC_by_week_full, open('ROC_by_week_full', 'wb'))